...
<body id="page-top">
    ...
    <div class="container-fluid bg">
        ...
        $sql = "SELECT * FROM tb_orders  WHERE  status =1 OR status =4 ORDER BY OrderID DESC";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if ($item['status'] == 1) { ?>
                                            ...
                                            <?php if ($item['status'] == 4) { ?>
                                                <div class="badge badge-danger text-white">ชำระเงินผิดพลาด</div>
                                            <?php  } ?>
        ...
        foreach ($query as $item) { ?>
            ...
            $sql = "SELECT  * FROM tb_product_image as tt
                             ...
                             WHERE tt.tb_product_id = '" . $result2['id_product'] . "'";
            $query = mysqli_query($connection, $sql);
            $result = mysqli_fetch_assoc($query);
            ...
            <div class="modal fade" id="ID<?php echo $item['OrderID'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="Update_payment.php" method="POST" id="form_con2">
                            <div class="modal-body">
                                ...
                                <?php if ($item['status'] != 4) { ?> 
                                    ...
                                    <input class="form-check-input" type="radio" name="check" id="inlineRadio1" value="1" <?php if ($item['status'] == 1) { ?> checked <?php  } ?>>
                                    <label class="form-check-label" for="inlineRadio1"> รอตรวจสอบการชำระเงิน</label>
                                </div>
                                <br>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="check" id="inlineRadio2" value="3" <?php if ($item['status'] == 3) { ?> checked <?php  } ?>>
                                    <label class="form-check-label" for="inlineRadio2"> ชำระเงินเงินแล้ว</label>
                                </div>
                                <br>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="check" id="inlineRadio3" value="4" <?php if ($item['status'] == 4) { ?> checked <?php  } ?>>
