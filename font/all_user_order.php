            ...
            <div>
                <label class="p-1 mx-3">รหัสคำสั่งซื้อ :&nbsp;<?php echo $item['OrderID']; ?> &nbsp; วันที่สั่งซื้อ :&nbsp;<?php echo $item['OrderDate']; ?>&nbsp;
                    <?php if ($item['status'] >= 5) { ?>
                        ...
                        <a href="https://th.kerryexpress.com/th/track/">เช็ค</a>
                    <?php } ?></label>
                <?php
                if ($item['status'] == 6) { ?>
                    <button class="btn btn-sm btn-Success float-end anone"> <a href="../admin/receipt2.php?id=<?php echo $item['OrderID'] ?>" class=""><i class="fas fa-print"></i> พิมพ์</a></button>
                <?php  } ?>
                ...
                <label class="float-end mx-3"> สถานะ : &nbsp;
                    ...
                    <?php
                    if ($item['status'] == 2) { ?>
                        <label class="float-end badge bg-danger mt-1">&nbsp;ยกเลิก</label>
                    <?php  }  ?>
                    <?php
                    if ($item['status'] == 3) { ?>
                        <label class="float-end badge bg-success mt-1">&nbsp;เตรียมการจัดส่ง</label>
                    <?php  }  ?>
                    <?php
                    if ($item['status'] == 4) { ?>
                    ...
                    <?php
                    if ($item['status'] == 6) { ?>
                        <label class="float-end badge bg-success mt-1">&nbsp;ได้รับสินค้าแล้ว</label>
                    <?php  }  ?>
